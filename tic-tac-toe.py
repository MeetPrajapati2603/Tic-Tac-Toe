...
# above line is used to show message to user

# now create instance of Tk it will allow to use tkinter methods.
root = Tk()

# now update the custom icon
root.iconbitmap('tictactoe icon.ico')

# now update the title of box
root.title('Tic Tac Toe')

# this will not allow user to resize the window
root.resizable(False, False)

# some global variables to use further in code.
click = True
count = 0
btn1 = StringVar()
btn2 = StringVar()
...
# now create functions will help in game
def play():
...
# now we will use mainloop method
